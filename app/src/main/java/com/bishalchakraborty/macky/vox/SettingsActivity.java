...
public class SettingsActivity extends AppCompatActivity {
    ...
    TextView status_user, name_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        status_user = findViewById(R.id.user_status);
        name_user = findViewById(R.id.user_name);

        image_circle = findViewById(R.id.profile_picture);

        change_image = findViewById(R.id.user_changeImage);
        change_status = findViewById(R.id.user_changeStatus);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!image.equals("default")) {
                    ...
                    //Picasso.with(SettingsActivity.this).load(image).placeholder(R.drawable.default_avatar).into(image_circle);

                    Picasso.with(SettingsActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                            .placeholder(R.drawable.default_avatar).into(image_circle, new com.squareup.picasso.Callback() {
                        @Override
        ...
        change_status.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String status_value = status_user.getText().toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                StorageReference filepath = imageStorage.child("profile_pictures").child(current_user_id + ".jpg");
                final StorageReference thumb_filepath = imageStorage.child("profile_pictures").child("thumbs").child(current_user_id + ".jpg");
